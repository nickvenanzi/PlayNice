...
class RankingViewModel: ObservableObject {
    ...
    @Published var answers: [Answer] = [
        ...
        Answer(answer: "Test Answer 2", prompt: "Prompt 2", author: "nick v", authorDocID: "xyzabc", winPercentage: 0.81, votes: 22, date: AnswerDate(year: 2024, month: 7, day: 18), globalRank: 10001),
